...
bool isSupportedRFRate(uint8_t index)
{
    ...
    if (POWER_OUTPUT_VALUES_DUAL_COUNT == 0 && (ModParams->radio_type == RADIO_TYPE_LR1121_LORA_2G4 || ModParams->radio_type == RADIO_TYPE_LR1121_GFSK_2G4 || ModParams->radio_type == RADIO_TYPE_LR1121_LORA_1500 || ModParams->radio_type == RADIO_TYPE_LR1121_GFSK_1500 || ModParams->radio_type == RADIO_TYPE_LR1121_LORA_DUAL))
    {
        return false;
    }
    return true;
