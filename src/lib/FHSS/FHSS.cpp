...
const fhss_config_t domains[] = {
    ...
    // {"CN1520", FREQ_HZ_TO_REG_VAL(1527500000), FREQ_HZ_TO_REG_VAL(1624500000), 40, 1576000000},
};
...
const fhss_config_t domains[] = {
    {
        ...
        "ISM2G4",
    #endif
    FREQ_HZ_TO_REG_VAL(2400400000), FREQ_HZ_TO_REG_VAL(2479400000), 40, 2440000000}
};
#endif
