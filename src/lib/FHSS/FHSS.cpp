...
const fhss_config_t domains[] = {
    ...
    {"CN315", FREQ_HZ_TO_REG_VAL(314000000), FREQ_HZ_TO_REG_VAL(316000000), 30, 315000000},
    ...
    {"CN532", FREQ_HZ_TO_REG_VAL(502000000), FREQ_HZ_TO_REG_VAL(562000000), 80, 532000000},
    {"CN2100", FREQ_HZ_TO_REG_VAL(2050000000), FREQ_HZ_TO_REG_VAL(2150000000), 80, 2100000000},
    {"CN2600", FREQ_HZ_TO_REG_VAL(2550000000), FREQ_HZ_TO_REG_VAL(2700000000), 80, 2625000000},
};
...
void FHSSrandomiseFHSSsequence(const uint32_t seed)
{
    ...
    DBGLN("FHSS center=%u Hz start=%u stop=%u", FHSSconfig->freq_center, FHSSconfig->freq_start, FHSSconfig->freq_stop);
